...
function Homepage() {
  ...
  return (
    <>
    <div style={{background:`url(${backbanner})`,backgroundSize:"cover",backgroundRepeat:"no-repeat",width:"100%",height:'600px'}}>

    <Container className='pt-5'>

    <Row className='m-0 text-center align-items-center p-5'>
      <Col  lg={2}>
      
<Image src={banner1} className='img-fluid' style={{height:"400px"}}/>
      </Col>
      <Col  lg={8}  className='hero_content'>
      <p  style={{fontSize:"60px",fontWeight:"bold",color:"white"}}>Bringing Dreams to Life with Bliss Events</p>
      ...
      <Col  lg={2}>
<Image src={banner2} className='img-fluid' style={{height:"400px"}}/>
    ...
    <Container className='my-5' >
      ...
      <Row className='p-2 '>
        ...
        <p className='text-secondary h2 text-uppercase'>Hire Us And</p>
...
<h2 className='text-center fw-bold mt-5'>Our Blissfull moments</h2>
      <Row className='my-4'>
        <Col lg={5}>
        <Image src={gall1} className='img-fluid rounded-5' style={{height:"360px",width:"100%"}}/>
        </Col>
        <Col lg={7}>
        <Image src={gall2} className='img-fluid rounded-5' style={{height:"360px",width:"100%"}} />
        </Col>
      </Row>

      <Row>
        <Col lg={7}>
        <Image src={gall3} className='img-fluid rounded-5' style={{height:"360px",width:"100%"}} />
        </Col>
        <Col lg={5}>
        <Image src={gall4} className='img-fluid rounded-5' style={{height:"360px",width:"100%"}} />
        </Col>
      </Row>
